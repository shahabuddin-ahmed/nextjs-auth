...
import { fetchCampaigns } from "@/lib/slices/campaignSlice"
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">Manage and create your email campaigns</p>
          </div>
          <Link href="/dashboard">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {campaigns.map((campaign) => (
                        <tr key={campaign.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 text-sm text-gray-600">{formatDate(campaign.scheduledTime)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
